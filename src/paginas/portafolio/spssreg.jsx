        ...
        <>
            <div className="contenedorPrincipal">
                ...
                <p>
                    ...
                    <img src={imgResumen3} alt="gráficos resumen" className="imgCentrada"></img>
                ...
                <p> <img src={imgCoeficientes} alt="tabla coeficientes"></img> </p>
                ...
                <p> <img src={imgCoeficientes2} alt="tabla multicolinealidad"></img> </p>
                ...
                <p> <img src={imgDiagnostico} alt="tabla residuos" className="imgCentrada"></img> </p>
