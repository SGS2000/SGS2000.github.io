        ...
        <>
            <div className="contenedorPrincipal">
                ...
                <p>
                    ...
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? SPSSFaccionEs  : SPSSFaccionEn } alt="Faccion"></img>
                ...
                <p>
                    ...
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? RSkillsCEs  : RSkillsCEn } alt="Habilidades combate"></img>
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? RSkillsMEs  : RSkillsMEn } alt="Habilidades magia"></img>
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? RSkillsSEs  : RSkillsSEn } alt="Habilidades sigilo"></img>
                ...
                <p>
                    ...
                    <img style={{ width: "35%", height: "35%" }} src={RMatriz} alt="Matriz habilidades" className="imgCentrada"></img>
                ...
                <p>
                    ...
                    {idioma === "es" ? "El mejor desempeño se obtuvo con bosques aletorios. Los resultados completos son los siguientes: "  : "The best performance was achieved with random forests. The complete results are as follows:" }
                </p>

                    <img style={{ width: "40%", height: "40%" }} src={idioma === "es" ? RResEs : RResEn} alt="Tabla resultados"></img>
                <p>
                    ...
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? RConfusionEs : RConfusionEn} alt="Confusion"></img>
                    <img style={{ width: "30%", height: "30%" }} src={idioma === "es" ? RImpEs : RImpEn} alt="Importancia"></img>
