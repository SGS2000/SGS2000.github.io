    ...
    return (
        <>
            <div className="contenedorPrincipal">
                <h1>{es ? "Temperaturas en Argentina" : "Temperatures in Argentina"}</h1>

                <h2> {es ? "Introducción" : "Introduction"} </h2>
                <p> {es ? "En este trabajo, se ajustó un modelo SARIMA para pronosticar futuros valores de las temperaturas en Argentina. Se trabajó con un conjunto de datos de "
                    ...
                    {es ? " que presenta las temperaturas promedio por mes entre 2015 y 2020."
                        : ", which provides average monthly temperatures between 2015 and 2020, was used."}</p>

                <p>{es ? "Presentado como trabajo final de la materia Series de tiempo (2021)." : "Presented as the final project for the Time Series course (2021)."} </p>

                <h2> {es ? "Análisis descriptivo" : "Descriptive Analysis"} </h2>
                <p> {es ? "La siguiente tabla muestra la temperatura promedio (ºC) por mes en Argentina durante el período 2015-2020. Las últimas seis observaciones son removidas para ser utilizadas como conjunto de prueba."
                ...
                <br></br>
                <p> {es ? "Se grafican los datos. Se puede observar una estacionalidad de período 12, lo cuál es esperable al trabajar con temperaturas mensuales."
                ...
                <div className="contenedorImagenCentrada">
                    <img src={es ? graficoSerieEs : graficoSerieEn} alt="Serie original" className="imgCentradaGrande"></img>
                </div>

                <p> {es ? "Se grafican la función de autocorrelación (FAC) y la función de autocorrelación parcial (FACP). Una vez más, se confirma la estacionalidad de período 12."
                ...
                <div className="contenedorGaleria">
                    <img src={es ? graficoFacEs : graficoFacEn} alt="FAC" className="imgGrande"></img>
                    <img src={es ? graficoFacpEs : graficoFacpEn} alt="FACP" className="imgGrande"></img>
                </div>

                <p> {es ? "Se aprecia una distribución similar por año, la variancia no parece aumentar ni disminuir con el tiempo. Se utiliza el test de Portmanteau para confirmar que la serie no es ruido blanco."
                ...
                <div className="contenedorImagen">
                    <img src={es ? graficoBoxplotEs : graficoBoxplotEn} alt="Boxplot" className="imgGrande"></img>
                    <img src={salidaTest} alt="test portmanteau"></img>
                </div>

                {/* Selección de modelos */}
                <h2> {es ? "Selección de modelos" : "Model Selection"} </h2>
                <p> {es ? "Se decidió aplicar una diferenciación de orden 1 tanto en la parte regular como en la parte estacional. A continuación se muestran los gráficos correspondientes a la serie diferenciada. "
                ...
                <div className="contenedorGaleria">
                    <img src={es ? graficoSerieDifEs : graficoSerieDifEn} alt="Serie diferenciada" className="imgGrande"></img>
                    <img src={es ? graficoFacDifEs : graficoFacDifEn} alt="FAC diferenciada" className="imgGrande"></img>
                    <img src={es ? graficoFacpDifEs : graficoFacpDifEn} alt="Boxplot" className="imgGrande"></img>
                </div>

                <p> {es ? "Los modelos que se contrastaron fueron los siguientes:"
                ...
                {/* Ajuste de modelos */}
                <h2> {es ? "Ajuste y diagnóstico del modelo" : "Model Fitting and Diagnosis"} </h2>
                <p>{es ? "El modelo óptimo fue el modelo 3: " : "The optimal model was Model 3: "}
                    SARIMA(0,1,1)(1,1,0)<sub>12</sub></p>
                <p>{es ? "Se presenta un resumen del modelo:" : "A summary of the model is shown:"} </p>

                <div className="contenedorImagen">
                    <img src={salidaModelo} alt="modelo optimo"></img>
                </div>

                <p>{es ? "A continuación, se lleva a cabo el diagnóstico del modelo. Como se puede ver en los siguientes gráficos, los residuos parecen ser ruido blanco y seguir una distribución aproximadamente normal." :
                ...
                <div className="contenedorGaleria">
                    <img src={es ? graficoDiagnostico1Es : graficoDiagnostico1En} alt="Residuos 1" className="imgGrande"></img>
                    <img src={es ? graficoDiagnostico2Es : graficoDiagnostico2En} alt="Residuos 2" className="imgGrande"></img>
                    <img src={es ? graficoDiagnostico3Es : graficoDiagnostico3En} alt="Residuos 3" className="imgGrande"></img>
                </div>

                <p>{es ? "El test de Portmanteau confirma que los residuos son ruido blanco. Finalmente, se aplica el test de Lilliefors para confirmar la normalidad de los residuos." :
                ...
                <h2> {es ? "Predicciones" : "Forecast"} </h2>
                ...
                <div className="contenedorImagenCentrada">
                    <img src={es ? tablaPredEs : tablaPredEn} alt="Predicciones" className="imgCentrada"></img>
                </div>
