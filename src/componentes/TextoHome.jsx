    ...
    return (
        ...
        <div id='contenedor-principal'>
            <div id='contenedor-texto'>
                ...
                <p id="texto-presentacion">{es ? "Científico de datos / Licenciado en Estadística / Desarrollador Web / Programador"
                    : "Data Scientist / Statistician / Full Stack Developer / Programmer"}</p>
